...
export function XtractFlow() {
  ...
  async function extract() {
    if (!selected) return;
    setStatus("extracting"); setResult(null); setNote("Sending the selected source to /api/xtract…");
    try {
